...
import loading_img_small from '../assets/img/loading-small.gif';
...
var style = {
    FullScreenLoading: {
        ...
        right: 0,
        bottom: 0,
        background: "url("+ loading_img+ ") white center center no-repeat"
    },
    Loading: {
        display: "block",
        height: "120px",
        background: "url("+ loading_img_small + ") transparent center center no-repeat"
    },
    Wrapper: {},
    Containers: {
        DefaultStyle: {
